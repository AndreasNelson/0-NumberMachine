...
public class Lab0Main {
  public static void main(String[] args) {
    ...
    System.out.println("    machine2's getSum() should be 7, and is actually: " + machine2.getSum());
    System.out.println();
    ...
    System.out.println("    machine3's getSum() should be 10, and is actually: " + machine3.getSum());
    System.out.println();
  }
}
